...
public class CarTrigger : MonoBehaviour
{
    ...
    // Строка для настройки скорости машины
    [SerializeField]
    ...
    {
        var player = collision.gameObject.GetComponent<MainCharacter>() as MonoBehaviour ?? collision.gameObject.GetComponent<SecMainCharacter>();
